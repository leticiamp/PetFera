...
//get's
int 
Tratador::getNivel_de_Seguranca(){
	return this->m_nivel_de_seguranca;
}

//sets
void 
Tratador::setNivel_de_Seguranca(int nivel_de_seguranca_){
	this->m_nivel_de_seguranca = nivel_de_seguranca_;
}

/** @brief Método de saída dos atributos da Classe Tratador. */
std::ostream& 
Tratador::print(std::ostream& os)const{
	os 	<< m_id << ";" 
		<< m_funcao << ";" 
		<< m_nome << ";"
	 	<< m_cpf << ";" 
